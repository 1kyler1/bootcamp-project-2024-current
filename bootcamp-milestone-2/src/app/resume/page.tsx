        ...
        <div>
            <main>
                ...
                <div className={styles.download}>
                    <Link href="/KylerResume-5.pdf" download="KylerResume-5.pdf">
                        Download Resume
                    </Link>
                </div>
                <h2 className="name">Kyler Nord</h2>
                <div className={styles.contact_info}>
                    <Link href="mailto:nordkyler@gmail.com">nordkyler@gmail.com</Link> *{" "}
                    <Link href="tel:206-557-9408">206-557-9408</Link> *{" "}
                    <Link href="https://www.linkedin.com/in/1kylernord1/" target="_blank" rel="noopener noreferrer">
                        LinkedIn
                    </Link> *{" "}
                    <Link href="https://github.com/1kyler1" target="_blank" rel="noopener noreferrer">
                        GitHub
                    </Link>
                </div>
                <div className={styles.resume_content}>
                    ...
                    <div className={styles.section}>
                        ...
                        <ul>
                            <li>
                                <strong>Programming Languages:</strong> Python, Arduino, Java, React, Git
                            </li>
                            <li>
                                <strong>IT Skills:</strong> Pandas, Streamlit, Figma, Adobe
                            </li>
                            <li>
                                <strong>Language Proficiency:</strong> Spanish (Seal of Biliteracy - ISA)
                            </li>
                        </ul>
                    </div>
                    <div className={styles.section}>
                        ...
                        <p>
                            <strong>Helium Miner Management (Personal Business)</strong>
                        ...
                        <p>
                            <strong>Cal Poly Startup Launch Weekend</strong>
                    ...
                    <div className={styles.section}>
                        <h2>Projects</h2>
                        <p>
                            <strong>NBA Combine Stats Website</strong>
                        ...
                        <p>
                            <strong>GPS Dog Collar with Alert System</strong>
